...
def getOptParser():
    ...
    optParser.add_option("--gext_e_const",         type="float",  help="External synaptic conductance to E (nS)")
    optParser.add_option("--rates_e_const",        type="float",  help="Frequency of synaptic conductance to E (Hz)")
    optParser.add_option("--gext_i_const",         type="float",  help="External synaptic conductance to I (nS)")
    optParser.add_option("--rates_i_const",        type="float",  help="Frequency of synaptic conductance to I (Hz)")
    ...
    optParser.add_option("--NMDA_amount_ext",   type="float", help="NMDA portion relative to AMPA for external inputs (%)")
    optParser.add_option("--NMDA_half",         type="float", help="NMDA half-maximal activation (mV)")
    ...
    optParser.add_option("--tau_AMPA_ext",      type="float",  help="Mean of AMPA synaptic conductance time constant for external inputs (ms)")
    ...
    optParser.add_option("--alpha_NMDA",        type="float",  help="controls the saturation properties of NMDAR channels (kHz)")
    ...
    optParser.add_option("--seed",              type="int",    help="Simulation seed; <0 for unseeded runs")
